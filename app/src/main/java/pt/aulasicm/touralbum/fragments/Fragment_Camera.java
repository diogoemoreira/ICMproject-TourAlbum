...
public class Fragment_Camera extends Fragment {
    ...
    private void AddToRealTimeDB(User user,DatabaseReference myRef,String filename) {
        GalleryItem im1=new GalleryItem("LocationTest","DescriptionTest","DateTest",filename);
        user.Album.add(im1);
